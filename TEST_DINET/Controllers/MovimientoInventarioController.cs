...
namespace TEST_DINET.Controllers
{
	public class MovimientoInventarioController: Controller
    {
        ...
        [HttpDelete]
        public async Task<IActionResult> EliminarMovimientoInventario(string COD_CIA,
            string COMPANIA_VENTA_3,
            string ALMACEN_VENTA,
            string TIPO_MOVIMIENTO,
            string TIPO_DOCUMENTO,
            ...
            string COD_ITEM_2)
        {
            ...
            try
            {
                var respuesta = await repositorioMovimientoInventario.EliminarMovimientoInventario(COD_CIA, COMPANIA_VENTA_3,ALMACEN_VENTA,
                                                                                                   TIPO_MOVIMIENTO,TIPO_DOCUMENTO,NRO_DOCUMENTO,COD_ITEM_2);
                N_PARM_SAL = respuesta.N_PARM_SAL;
                C_PARM_SAL = respuesta.C_PARM_SAL;
            }
